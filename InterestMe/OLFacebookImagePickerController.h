...
// PHOTO NUM DEFINITION: (Zero indexed)
// 0 is Prof Pic
// 1 is Second Pic
// 2 is Third Pic
// And so forth if the functionality to add even more photos is built in the near future.
@property NSInteger photoNum; //added by DJAX
