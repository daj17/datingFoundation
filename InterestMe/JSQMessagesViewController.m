               ...
               message:(id<JSQMessageData>)messageItem
{
    ...
    if (!isMediaMessage) {
        cell.accessibilityLabel =[NSString stringWithFormat:@"%@: %@",[messageItem senderDisplayName],[messageItem text]];
        
        
        
        
        //[NSString stringWithFormat:[NSBundle jsq_localizedStringForKey:@"text_message_accessibility_label"],
                                  // [messageItem senderDisplayName],
                                   //[messageItem text]];
    }
    else {
        cell.accessibilityLabel =@"tesdfgdfgt";
//        cell.accessibilityLabel = [NSString stringWithFormat:@"%@: %@",[messageItem senderDisplayName]];
