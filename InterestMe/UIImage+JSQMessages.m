...
//below methods altered by djax



+ (UIImage *)jsq_bubbleRegularImage
{
    return [UIImage imageNamed:@"bubble_regular.png"];
...
{
    return [UIImage imageNamed:@"bubble_tailless.png"];
...
{
    return [UIImage imageNamed:@"bubble_stroked.png"];
...
{
    return [UIImage imageNamed:@"bubble_stroked_tailless.png"];
...
{
    return [UIImage imageNamed:@"bubble_min.png"];
...
{
    return [UIImage imageNamed:@"bubble_min_tailless.png"];
...
{
    return [UIImage imageNamed:@"clip.png"];
...
{
    return [UIImage imageNamed:@"typing.png"];
...
{
    return [UIImage imageNamed:@"pause.png"];
