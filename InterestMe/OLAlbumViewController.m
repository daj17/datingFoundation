...
{
    [self.navigationItem setLeftBarButtonItem:[[UIBarButtonItem alloc] initWithTitle:@"Cancel" style:UIBarButtonItemStylePlain target:self action:@selector(cancelButtonClickedInAlbums)]
                                     animated:animated];
}

-(void)cancelButtonClickedInAlbums  {
    // dismiss this view.
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"cancelFacebookPhotoChoose"
                                                        object:self
                                                      userInfo:nil];
