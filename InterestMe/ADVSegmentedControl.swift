...
@IBDesignable class ADVSegmentedControl: UIControl, UIGestureRecognizerDelegate {
    
    private var labels = [UILabel]()
    var thumbView = UIView()
    
    var items: [String] = ["CHAT", "OFFLINE"] {
        didSet {
            setupLabels()
        }
    }
...
//    }
    ...
    func setupLabels(){
        ...
        let tap:UISwipeGestureRecognizer = UISwipeGestureRecognizer(target: self, action: "handleSwipeGesture:")
    ...
    func handleSwipeGesture(gr:UISwipeGestureRecognizer){
        switch gr.direction {
        ...
        case UISwipeGestureRecognizerDirection.Right:
            ...
            currentUser.setObject("NO", forKey: "playing")
            currentUser.saveInBackground()
            NSNotificationCenter.defaultCenter().postNotificationName("playingStatusChanged", object: self)
        ...
        case UISwipeGestureRecognizerDirection.Left:
            ...
            var currentUser:PFUser = PFUser.currentUser()!
            currentUser.setObject("YES", forKey: "playing")
            currentUser.saveInBackground()
            NSNotificationCenter.defaultCenter().postNotificationName("playingStatusChanged", object: self)
