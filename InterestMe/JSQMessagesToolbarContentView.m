...
const CGFloat kJSQMessagesToolbarContentViewHorizontalSpacingDefault = -25.0f;
...
- (void)awakeFromNib
{
    ...
    self.rightHorizontalSpacingConstraint.constant = 8.0f;//kJSQMessagesToolbarContentViewHorizontalSpacingDefault;
...
- (void)setRightBarButtonItem:(UIButton *)rightBarButtonItem
{
    ...
    self.rightBarButtonContainerView.hidden = NO;
        self.rightHorizontalSpacingConstraint.constant = 13.0f;
