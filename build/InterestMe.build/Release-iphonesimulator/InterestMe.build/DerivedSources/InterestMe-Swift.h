...
SWIFT_CLASS("_TtC10InterestMe19ADVSegmentedControl")
@interface ADVSegmentedControl : UIControl <UIGestureRecognizerDelegate>
...
- (void)setFont;
- (void)handleSwipeGesture:(UISwipeGestureRecognizer * _Nonnull)gr;
@end
